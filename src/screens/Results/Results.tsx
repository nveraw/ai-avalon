    ...
    <div className="max-w-lg mx-auto px-5 py-10 text-center">
      <div
        ...
        ${
          good
            ...
            : "bg-[radial-gradient(ellipse_at_top,rgba(127,29,29,0.8), rgba(10,12,25,0.95))]πr border-red-700 shadow-[0_0_80px_#dc262633]"
        }`}
      >
      ...
      <CardBox className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {allPlayers.filter(p => p.role !== "assassin").map((player, i) => {
            return (
              <div
                key={i}
                className={`p-3 rounded-xl border relative
                ${player === assassinated ? "ring-2 ring-red-500/60" : ""}
                ${
              ...
              >
                ...
                <div
                  className={`text-[11px] font-serif ${PLAYER_ROLES[player.role].color}`}
                >
